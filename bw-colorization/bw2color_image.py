...
# load our serialized black and white colorizer model
# and cluster center points from disk
print("[INFO] loading model...")
net = cv2.dnn.readNetFromCaffe(args["prototxt"], args["model"])
pts = np.load(args["points"])

# add the cluster centers as 1x1 convolutions to the model
# for more info about blobs, see: https://caffe.berkeleyvision.org/tutorial/net_layer_blob.html
...
# then scale the pixel intensities to the range [0, 1] by dividing 255,
scaled = image.astype("float32") / 255.0
# and finally, convert the image from the BGR to Lab colorspace.
